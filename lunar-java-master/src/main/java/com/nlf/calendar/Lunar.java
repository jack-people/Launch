...
public class Lunar {
  ...
  private void computeJieQi(LunarYear lunarYear) {
    ...
    for (int i = 0, j = LunarUtil.JIE_QI_IN_USE.length; i < j; i++) {
      jieQi.put(LunarUtil.JIE_QI_IN_USE[i], Solar.fromJulianDay(julianDays.get(i)));
    }
  }
  ...
  public List<String> getFestivals() {
    ...
    if (Math.abs(month) == 12 && day >= 29 && year != next(1).getYear()) {
      l.add(I18n.getMessage("jr.chuXi"));
    }
    return l;
  }
  ...
  public List<String> getOtherFestivals() {
    ...
    String solarYmd = solar.toYmd();
    if (solarYmd.equals(getJieQiSolar(I18n.getMessage("jq.qingMing")).next(-1).toYmd())) {
      l.add("寒食节");
    }
  ...
  public String getMonthPositionTaiSui(int sect) {
    ...
    return new String[]{I18n.getMessage("bg.gen"), LunarUtil.POSITION_GAN[monthGanIndex], I18n.getMessage("bg.kun"), I18n.getMessage("bg.xun")}[m % 4];
  }
  ...
  public String getDayPositionTaiSui(int sect) {
    ...
    String p;
    if (Arrays.asList(I18n.getMessage("jz.jiaZi"), I18n.getMessage("jz.yiChou"), I18n.getMessage("jz.bingYin"), I18n.getMessage("jz.dingMao"), I18n.getMessage("jz.wuChen"), I18n.getMessage("jz.jiSi")).contains(dayInGanZhi)) {
      p = I18n.getMessage("bg.zhen");
    } else if (Arrays.asList(I18n.getMessage("jz.bingZi"), I18n.getMessage("jz.dingChou"), I18n.getMessage("jz.wuYin"), I18n.getMessage("jz.jiMao"), I18n.getMessage("jz.gengChen"), I18n.getMessage("jz.xinSi")).contains(dayInGanZhi)) {
      p = I18n.getMessage("bg.li");
    } else if (Arrays.asList(I18n.getMessage("jz.wuZi"), I18n.getMessage("jz.jiChou"), I18n.getMessage("jz.gengYin"), I18n.getMessage("jz.xinMao"), I18n.getMessage("jz.renChen"), I18n.getMessage("jz.guiSi")).contains(dayInGanZhi)) {
      p = I18n.getMessage("ps.center");
    } else if (Arrays.asList(I18n.getMessage("jz.gengZi"), I18n.getMessage("jz.xinChou"), I18n.getMessage("jz.renYin"), I18n.getMessage("jz.guiMao"), I18n.getMessage("jz.jiaChen"), I18n.getMessage("jz.yiSi")).contains(dayInGanZhi)) {
      p = I18n.getMessage("bg.dui");
    } else if (Arrays.asList(I18n.getMessage("jz.renZi"), I18n.getMessage("jz.guiChou"), I18n.getMessage("jz.jiaYin"), I18n.getMessage("jz.yiMao"), I18n.getMessage("jz.bingChen"), I18n.getMessage("jz.dingSi")).contains(dayInGanZhi)) {
  ...
  public NineStar getTimeNineStar() {
    String solarYmd = solar.toYmd();
    boolean asc = false;
    if ((solarYmd.compareTo(getJieQiSolar(I18n.getMessage("jq.dongZhi")).toYmd()) >= 0 && solarYmd.compareTo(getJieQiSolar(I18n.getMessage("jq.xiaZhi")).toYmd()) < 0)) {
      asc = true;
  ...
  public String getWuHou() {
    ...
    LunarUtil.IndexValue jq = LunarUtil.find(jieQi.getName(), LunarUtil.JIE_QI);
    int offset = 0;
    if (null != jq) {
      offset = jq.getIndex();
    }
  ...
  private void checkLang() {
    ...
    if (!newLang.equals(lang)) {
      List<Solar> l = new ArrayList<Solar>(jieQi.values());
      jieQi.clear();
      for (int i = 0, j = LunarUtil.JIE_QI_IN_USE.length; i < j; i++) {
        jieQi.put(LunarUtil.JIE_QI_IN_USE[i], l.get(i));
      }
      lang = newLang;
    }
  }

  private Solar getJieQiSolar(String name) {
    return getJieQiTable().get(name);
  }
