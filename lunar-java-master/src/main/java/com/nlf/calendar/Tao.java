...
public class Tao {
  ...
  public List<TaoFestival> getFestivals() {
    ...
    if (I18n.getMessage("jq.dongZhi").equals(jq)) {
      l.add(new TaoFestival("元始天尊圣诞"));
    } else if (I18n.getMessage("jq.xiaZhi").equals(jq)) {
  ...
  public boolean isDayMingWu() {
    return I18n.getMessage("tg.wu").equals(lunar.getDayGan());
  }
  ...
  public boolean isDayTianShe() {
    ...
    if (Arrays.asList(I18n.getMessage("dz.yin"), I18n.getMessage("dz.mao"), I18n.getMessage("dz.chen")).contains(mz)) {
      if (I18n.getMessage("jz.wuYin").equals(dgz)) {
        ret = true;
      }
    } else if (Arrays.asList(I18n.getMessage("dz.si"), I18n.getMessage("dz.wu"), I18n.getMessage("dz.wei")).contains(mz)) {
      if (I18n.getMessage("jz.jiaWu").equals(dgz)) {
        ret = true;
      }
    } else if (Arrays.asList(I18n.getMessage("dz.shen"), I18n.getMessage("dz.you"), I18n.getMessage("dz.xu")).contains(mz)) {
      if (I18n.getMessage("jz.wuShen").equals(dgz)) {
        ret = true;
      }
    } else if (Arrays.asList(I18n.getMessage("dz.hai"), I18n.getMessage("dz.zi"), I18n.getMessage("dz.chou")).contains(mz)) {
      if (I18n.getMessage("jz.jiaZi").equals(dgz)) {
        ret = true;
      }
    }
    return ret;
